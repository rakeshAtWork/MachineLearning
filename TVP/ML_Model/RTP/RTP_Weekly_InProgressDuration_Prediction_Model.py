...
def data_preprocessing(dataset_required, return_whole_encoded_dataset=False):
    ...
    dataset_required['week no'] = dataset_required['Call Date'].dt.isocalendar().week
    ...
    progress_modified = pd.get_dummies(dataset_required, columns=['Priority', 'Category', 'Subcategory', 'Ticket Type','week no'])
